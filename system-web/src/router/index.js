  ...
  // 学生管理
    {
        ...
        children: [{
          ...
          name: 'student',
          meta: { title: 'studentManage', icon: 'people', noCache: true }
        }]
    },
    // 班级管理
    {
        ...
        children: [{
          ...
          name: 'grade',
          meta: { title: 'gradeManage', icon: 'component', noCache: true }
        }]
    },
    ...
    //教师管理
    {
        ...
        children: [{
          ...
          name: 'teacher',
          meta: { title: 'teacherManage', icon: 'component', noCache: true }
        }]
    },
